...
export default function BotonWhatsApp() {
  return (
    <a
      ...
      className="fixed right-5 bottom-5 z-50 flex min-h-12 items-center gap-2.5 rounded-full bg-[#128C4A] py-3.5 pr-5 pl-4 font-medium text-white shadow-xl shadow-black/25 transition-transform duration-200 ease-out hover:-translate-y-0.5"
    >
